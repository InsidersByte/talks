...
const Presentation = () => (
  <Spectacle theme={theme}>
    <Deck transition={['zoom', 'slide']} transitionDuration={500}>
      ...
      <Slide bgColor="#222222" notes="<ul><li>Who has heard of it?</li><li>Who is considering learning / using it?</li><li>Who is using it?</li></ul>">
        <Image src={images.reactLogo.replace('/', '')} height="700px" />
      </Slide>

      <Slide notes="Released in March 2013">
        <BlockQuote>
      ...
      <Slide>
        ...
        <List textColor="tertiary">
          ...
          <Appear><ListItem margin="0 0 0.5em">React doesn't use templates or HTML directives</ListItem></Appear>
      ...
      <Slide maxWidth={1082} notes="over 2.5 million downloads per month">
        <Heading margin="0 0 0.5em" fontSize="6rem">npm download stats</Heading>
      ...
      <Slide>
        ...
        <List textColor="tertiary">
          ...
          <Appear><ListItem margin="0 0 0.5em">Testing is easy!</ListItem></Appear>
        </List>
      </Slide>
